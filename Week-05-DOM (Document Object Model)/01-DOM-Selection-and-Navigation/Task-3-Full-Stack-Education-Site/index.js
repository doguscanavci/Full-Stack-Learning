...
topContenth4[0].textContent = siteContent['top-content']['left-h4'];
topContenth4[1].textContent = siteContent['top-content']['right-h4'];
...
bottomContenth4[0].textContent = siteContent['bottom-content']['left-h4'];
bottomContenth4[1].textContent = siteContent['bottom-content']['middle-h4'];
bottomContenth4[2].textContent = siteContent['bottom-content']['right-h4'];

const bottomContentP = document.querySelectorAll('.bottom-content p');
bottomContentP[0].textContent = siteContent['bottom-content']['left-content'];
bottomContentP[1].textContent = siteContent['bottom-content']['middle-content'];
bottomContentP[2].textContent = siteContent['bottom-content']['right-content'];
