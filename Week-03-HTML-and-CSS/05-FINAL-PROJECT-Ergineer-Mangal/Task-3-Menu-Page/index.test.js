...
describe('index.html', () => {
  ...
  it('html-24 Çorbalar ve Salatalar menüsünde 3 tane menu-item var', () => {
    const elements = container.querySelectorAll(
  ...
  it('html-28 mezeler menüsünde 3 tane menu-item var', () => {
    const elements = container.querySelectorAll(
  ...
  it('html-32 tatlılar menüsünde 3 tane menu-item var', () => {
    const elements = container.querySelectorAll(
  ...
  it("html-34 tatlılar menüsünde her menu-item'da toplam 5 adet p var", () => {
    const elements = container.querySelectorAll(
